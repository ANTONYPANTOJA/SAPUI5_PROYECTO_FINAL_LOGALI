		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "RRHH - Employees",
									"targetURL": "#logaligrouprrhhemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligrouprrhhemployees-display": {
								"semanticObject": "logaligrouprrhhemployees",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.rrhhemployees",
									"url": sap.ui.require.toUrl("logaligroup/rrhhemployees")
								}
							}
						}
					}
